...
case "$powermode" in
    "2")
        ...
        echo "10000 1400000:20000 1700000:10000" > /sys/devices/system/cpu/cpufreq/interactive/above_hispeed_delay
        ...
        echo "85 1500000:95" > /sys/devices/system/cpu/cpufreq/interactive/target_loads
        start mpdecision
        ;;
    "1")
        #Balanced
        ...
        echo 1958400 > /sys/devices/system/cpu/cpu2/cpufreq/scaling_max_freq
        echo 1958400 > /sys/devices/system/cpu/cpu3/cpufreq/scaling_max_freq
        echo "90 1500000:99" > /sys/devices/system/cpu/cpufreq/interactive/target_loads
        start mpdecision
        ;;
    "0")
        #PowerSave
