...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/rootdir/etc/dolby/ds-default.xml:system/etc/dolby/ds-default.xml \
    $(LOCAL_PATH)/rootdir/lib/libdlbdapstorage.so:system/lib/libdlbdapstorage.so \
    $(LOCAL_PATH)/rootdir/lib/soundfx/libswdap-mod.so:system/lib/soundfx/libswdap-mod.so \
...
# art preloaded classes optimization
